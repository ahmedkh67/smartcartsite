  ...
  return (
    ...
    <div className="flex justify-center items-center w-full md:h-[550px] h-[450px] HeroBackground">
        ...
        <div className="flex md:flex-row flex-col bg-white justify-center items-center px-4 pt-10 flex-wrap">       
            <div className="flex flex-col bg-[#ededed] p-8 w-full md:w-90 h-90 md:m-4 my-3 justify-center items-end elctrcar1 "> 

                
            </div>
            <div className="flex flex-col bg-[#ededed] p-8 w-full md:w-90 h-90 md:m-4 my-3 justify-center items-end elctrcar2"> 

                
            </div>
            <div className="flex flex-col bg-[#ededed] p-8 w-full md:w-90 h-90 md:m-4 my-3 justify-center items-end elctrcar3"> 

                
            </div>
            <div className="flex flex-col bg-[#ededed] p-8 w-full md:w-90 h-90 md:m-4 my-3 justify-center items-end elctrcar4"> 

                
            </div>
            <div className="flex flex-col bg-[#ededed] p-8 w-full md:w-90 h-90 md:m-4 my-3 justify-center items-end elctrcar5"> 
